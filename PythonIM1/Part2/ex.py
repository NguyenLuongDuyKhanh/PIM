...
def cpu_move():
    ...
    if button_1['text'] == 'X' and button_3['text'] == 'X' and button_2['text'] != 'X':
        button_2['text'] = 'X'
        buttons.remove(button_2)
        return

    if button_2['text'] == 'X' and button_3['text'] == 'X' and button_1['text'] != 'X':
        button_1['text'] = 'X'
    ...
    if button_4['text'] == 'X' and button_6['text'] == 'X' and button_5['text'] != 'X':
        button_5['text'] = 'X'
        buttons.remove(button_5)
        return

    if button_5['text'] == 'X' and button_6['text'] == 'X' and button_4['text'] != 'X':
        button_4['text'] = 'X'
    ...
    if button_7['text'] == 'X' and button_9['text'] == 'X' and button_8['text'] != 'X':
        button_8['text'] = 'X'
        buttons.remove(button_8)
        return

    if button_8['text'] == 'X' and button_9['text'] == 'X' and button_7['text'] != 'X':
        button_7['text'] = 'X'
    ...
    if button_1['text'] == 'X' and button_7['text'] == 'X' and button_4['text'] != 'X':
        button_4['text'] = 'X'
        buttons.remove(button_4)
        return

    if button_4['text'] == 'X' and button_7['text'] == 'X' and button_1['text'] != 'X':
        button_1['text'] = 'X'
        buttons.remove(button_1)
        return
    ...
    if button_2['text'] == 'X' and button_8['text'] == 'X' and button_5['text'] != 'X':
        button_5['text'] = 'X'
        buttons.remove(button_5)
        return

    if button_5['text'] == 'X' and button_8['text'] == 'X' and button_2['text'] != 'X':
        button_2['text'] = 'X'
        buttons.remove(button_2)
        return
    ...
    if button_3['text'] == 'X' and button_9['text'] == 'X' and button_6['text'] != 'X':
        button_6['text'] = 'X'
        buttons.remove(button_6)
        return

    if button_6['text'] == 'X' and button_9['text'] == 'X' and button_3['text'] != 'X':
        button_3['text'] = 'X'
        buttons.remove(button_3)
        return
    ...
    if button_1['text'] == 'X' and button_9['text'] == 'X' and button_5['text'] != 'X':
        button_5['text'] = 'X'
        buttons.remove(button_5)
        return

    if button_5['text'] == 'X' and button_9['text'] == 'X' and button_1['text'] != 'X':
        button_1['text'] = 'X'
        buttons.remove(button_1)
        return
    ...
    if button_3['text'] == 'X' and button_7['text'] == 'X' and button_5['text'] != 'X':
        button_5['text'] = 'X'
        buttons.remove(button_5)
        return

    if button_5['text'] == 'X' and button_7['text'] == 'X' and button_3['text'] != 'X':
        button_3['text'] = 'X'
        buttons.remove(button_3)
        return
