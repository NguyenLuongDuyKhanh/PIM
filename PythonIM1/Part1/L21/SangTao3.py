...
def check_collide_food(tur1, food):
    global score
    if ((tur1.xcor() < (food.xcor() + 23)) and (tur1.xcor() > (food.xcor() - 23)) and (tur1.ycor() < (food.ycor() + 23)) and (tur1.ycor() > (food.ycor() - 23))):
        #food.hideturtle()
        score = score + 10
