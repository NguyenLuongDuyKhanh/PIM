...
tur.goto(0,-430)
tur.ondrag(tur.goto)
# tur2 is the main turtle to race
tur2 = turtle.Turtle()
tur2.shape("turtle")
tur2.penup()
tur2.fillcolor("white")
tur2.pencolor("red")
tur2.left(90)


tur2.goto(-100,-430)
tur2.ondrag(tur.goto)
...
def move_up2():
    if tur2.ycor() < 430:
        tur2.goto(tur2.xcor(), tur2.ycor() + 20)
...
def move_right2():
    if tur.xcor() < 190:
        tur2.goto(tur2.xcor() + 20, tur2.ycor())
...
s.onkeypress(move_up2, "w")
s.onkeypress(move_down2, "s")
s.onkeypress(move_right2, "d")
s.onkeypress(move_left2, "a")
...
while game:
    if lose == False:
        ...
        while lose == False:
            ...
            check_collide(tur2, obs)
            check_collide(tur2, obs1)
            check_collide(tur2, obs2)
            check_collide(tur2, obs3)
            if collide == True:
                lose = True
